...
//   {/* Summary Section (Only Render Once, Outside of map) */}
...
//         <p className="font-normal text-base">₹{(products.reduce((total, item) => total + (item.price * item.quantity), 0)).toFixed(2)}</p>
//       </div>
//       <div className="flex justify-between items-center">
...
//         <p className="font-bold text-[14px]">₹{(products.reduce((total, item) => total + (item.price * item.quantity), 0)).toFixed(2)}</p>
//       </div>
//     </div>
//     {/* Checkout Button */}
