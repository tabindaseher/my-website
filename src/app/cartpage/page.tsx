...
//     const cart = JSON.parse(localStorage.getItem("cart") || "{}")
//     delete cart[productName]  // Remove item by productName
...
//       const total = updatedProducts.reduce((acc: number, product: IProduct) => {
//         const quantity = product.quantity ?? 0;  // Use 0 if quantity is undefined
//         return acc + (product.price * quantity);
//   }, 0)
//       setTotalAmount(total)
...
//         // Type the accumulator explicitly as 'number' in reduce
//         const total = updatedProducts.reduce<number>((acc, product) => {
...
//       } else {
//         console.error('Cart is not an object or is undefined');
//       }
